...
from jangl_utils.settings import AUTH_MIDDLEWARE_USE_CACHE
...
def get_cached_user(request, use_cache=AUTH_MIDDLEWARE_USE_CACHE):
...
def get_cached_site(request, use_cache=AUTH_MIDDLEWARE_USE_CACHE):
...
def get_cached_superuser(request, use_cache=AUTH_MIDDLEWARE_USE_CACHE):
